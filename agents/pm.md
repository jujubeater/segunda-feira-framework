...
commands:
  ...
  - name: create-prd
    visibility: [full, quick, key]
    description: 'Expert-led facilitation to create Product Requirements Document'
  - name: validate-prd
  ...
  - name: create-epic
    visibility: [full, quick, key]
    description: 'Create epic with stories listing from architecture'
  - name: create-story
    visibility: [full, quick]
...
- `*create-product-brief` - Guided product brief creation
...
- `*create-epic` - Create epic with stories listing
- `*execute-epic {path}` - Execute epic plan with wave-based parallel development

**Readiness & Validation:**

- `*implementation-readiness` - Verify all artifacts aligned before dev
