...
commands:
  ...
  - name: context-story
    ...
    description: 'Prepare story with all required context for implementation'
  ...
  - name: sprint-planning
    visibility: [full, quick, key]
    description: 'Generate or update sprint plan sequencing tasks for the project'
  - name: sprint-status
    visibility: [full, quick]
    description: 'Track sprint progress by scanning epic/story files'
  - name: retrospective
    visibility: [full, quick]
    description: 'Epic retrospective - multi-perspective review of completed work'
  - name: correct-course
    visibility: [full, quick]
    description: 'Determine how to proceed when major changes discovered mid-implementation'

  # Process Management
  # NOTE: correct-course escalation to @aios-master still available
...
- `*context-story` - Prepare story with full implementation context
- `*story-checklist` - Execute story draft checklist

**Sprint Management:**

- `*sprint-planning` - Generate/update sprint plan
- `*sprint-status` - Track sprint progress
- `*retrospective` - Epic retrospective
- `*correct-course` - Handle mid-implementation changes
