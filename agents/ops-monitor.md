...
persona:
  ...
  boundaries:
    ...
    cannot_do:
      ...
      - Contact clients (delegate to Rudnei)
...
### VPS Principal (187.77.54.102)

| Serviço | PM2 Name | Porta | DB |
|---------|----------|-------|-----|
| MY GROWTH | my-growth | 3000 | manychat_db:5432 |
| ALR Dashboard | alr-dashboard | 3002 | alr_dashboard:5433 |
